...
public class EsyVendingGUI{
    ...
    public void errorMessage(String errorMessage){
        ...
        dialog = (ErrorDialog)factory.createGui(7);
    ...
    public void login(){
        ...
        //</editor-fold>
         login = (Login)factory.createGui(2);
         this.login.setSystemObserver(ov);
        /* Create and display the form */       
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
    ...
    public void setUp(){
     ...
     machineSetup= (MachineSetup)factory.createGui(3);
     this.machineSetup.setSystemObserver(ov);
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
    ...
    public void loginSetup(){
        ...
        //</editor-fold>
         changeLogin = (ChangeLogin)factory.createGui(4);
         this.changeLogin.setSystemObserver(ov);
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
    ...
    public void businessSetup(){
       ...
       /* Set the Nimbus look and feel */
        ...
        // this hopefully wil be our ear to the events in class
             ...
             *
             */
        businessSetUp  = (BusinessSetUp)factory.createGui(5);
        this.businessSetUp.setSystemObserver(ov);
    ...
    public void incidents(ArrayList<String> n){
        incidents  = (ErrorReport)factory.createGui(8);
    ...
    public void runSimulator(){
       simulator = (Simulator)factory.createGui(6);
       this.simulator.setSystemObserver(ov);
       java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
