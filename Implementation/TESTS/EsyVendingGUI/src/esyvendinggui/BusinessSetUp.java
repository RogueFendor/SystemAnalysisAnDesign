...
public class BusinessSetUp extends javax.swing.JFrame {
    ...
    public String getALL(){
     return " Test "+this.getProductName()+" "+this.getPrice()+" "+this.getSlotID()+" "+this.getQuant()+" "+this.getTempRange()+" "+this.getCurrencyType();
    ...
    private void initComponents() {
        ...
        products.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Products:", "Item 1", "Item 2", "Item 3", "Item 4" }));
