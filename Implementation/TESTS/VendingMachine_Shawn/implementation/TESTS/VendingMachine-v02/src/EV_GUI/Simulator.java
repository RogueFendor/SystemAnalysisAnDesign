...
public class Simulator extends javax.swing.JFrame {
    ...
    public void setCurrentPrice(double currentPrice) {
     ...
     public int index;
     public Simulator(ObservableVals ov) {
       initComponents();
       this.systemObserver = ov;
       this.cent5.setEnabled(false);
       this.cent10.setEnabled(false);
       this.cent50.setEnabled(false);
       this.cent20.setEnabled(false);
       this.euro1.setEnabled(false);
       this.euro2.setEnabled(false);
       this.euro5.setEnabled(false);
    }
    ...
    private void weigthImballanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_weigthImballanceActionPerformed
        ...
        this.systemObserver.setIsWeightImballance(true);
    ...
    private void shockDetectorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shockDetectorActionPerformed
        // TODO add your handling code here:
        this.systemObserver.setIsTestVandalism(true);
    ...
    private void tempImballanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tempImballanceActionPerformed
        // TODO add your handling code here:
        this.systemObserver.setIsWeightImballance(rootPaneCheckingEnabled);
    ...
    private void paymentCashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paymentCashActionPerformed
        // TODO add your handling code here:
        this.cent5.setEnabled(true);
       this.cent10.setEnabled(true);
       this.cent50.setEnabled(true);
       this.cent20.setEnabled(true);
       this.euro1.setEnabled(true);
       this.euro2.setEnabled(true);
       this.euro5.setEnabled(true);
    ...
    private void cent5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cent5ActionPerformed
        ...
        this.setCurrentPrice((this.currentPrice - 0.05));
         System.out.println("5 cent " + this.getCurrentPrice());
    ...
    private void cent10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cent10ActionPerformed
        ...
        this.setCurrentPrice((this.currentPrice - 0.1));
         System.out.println("10 cents " + this.getCurrentPrice());
    ...
    private void cent20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cent20ActionPerformed
        ...
        this.setCurrentPrice((this.currentPrice - 0.2));
         System.out.println("20 cents " + this.getCurrentPrice());
    ...
    private void cent50ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cent50ActionPerformed
        ...
        System.out.println("O.50 cent " + this.getCurrentPrice());
    ...
    private void euro1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_euro1ActionPerformed
        ...
        this.setCurrentPrice((this.currentPrice - 1.0));
         System.out.println(" 1 euro" + this.getCurrentPrice());
    ...
    private void euro2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_euro2ActionPerformed
        ...
        System.out.println("2 euro " + this.getCurrentPrice());
    ...
    private void euro5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_euro5ActionPerformed
        ...
        System.out.println("5 euro " + this.getCurrentPrice());
